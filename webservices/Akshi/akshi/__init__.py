...
app.register_blueprint(data.api_v1)
app.register_blueprint(data.api_v2)
...
def setup_user():
    import yaml
    from .signage.models import signage_db, User


    with open("/opt/signage/web.yml", 'r') as ymlfile:
