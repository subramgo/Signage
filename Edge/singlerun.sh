...
FILE_TO_WATCH=/home/pi/Signage/webservice/Akshi/ws.log
SEARCH_PATTERN='0.0.0.0'
rm -rf ${FILE_TO_WATCH}
nohup sh /home/pi/Signage/webservice/Akshi/run.sh 1> ${FILE_TO_WATCH} 2>/dev/null &
sleep 5
echo "Web service loaded"


sleep 15
python3 /home/pi/Signage/Edge/client.py -g True  -c 0 -w http:michael:irkbin//127.0.0.1:5000/api/v1/signage/signage_upload  -l signage-analysis-demo -i signage-camera-1
